...
import {
  editOtherAdminData,
  editOtherChemistData,
  editOtherPatientData,
  getAccountDetails,
  getAdminData,
  getChemistData,
  getPatientData,
...
function EditSingleAccount() {
  ...
  const handleEditPatient = () => {
    ...
    if (patient) {
      ...
      editOtherPatientData(id, body, tag)
        .then((res) => {
      ...
      editOtherChemistData(id, body, tag)
        .then((res) => {
          setLoading((state) => !state);
          navigate(`/accounts/${id}/details`);
          toast.success(t("success"), {
      ...
      editOtherAdminData(id, body, tag)
        .then((res) => {
          setLoading((state) => !state);
          navigate(`/accounts/${id}/details`);
          toast.success(t("success"), {
